...
public class HorarioJpaController implements Serializable {
    ...
    //Al llamar al jpa controller hara una nueva instancia de administrador de entidades, segun el archivo persistence
    public HorarioJpaController() {
        emf = Persistence.createEntityManagerFactory("teresfoodPU");
    }
